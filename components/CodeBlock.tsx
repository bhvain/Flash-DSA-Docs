    ...
    <div className="relative group rounded-xl overflow-hidden border border-gray-800 bg-gray-950 mb-4">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute right-2 top-2 p-2 rounded-lg bg-gray-800/60 hover:bg-gray-700/80 text-gray-400 hover:text-gray-100 opacity-0 group-hover:opacity-100 transition-all focus:opacity-100 border border-gray-700/50 backdrop-blur-sm"
